...
const webpackConfig = {
  background: require('./src/background/webpack.config.js'),
  popup: require('./src/popup/webpack.config.js'),
  content: require('./src/content/webpack.config.js'),
}
